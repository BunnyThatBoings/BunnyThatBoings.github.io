...
const playerCompletions = {
  ...
  "wPopoff": ["Society (V)", "Amethyst (V)", "Thinking Space II (1)", "Tidal Wave", "BOOBAWAMBA", "Every End", "Subsuming Vortex", "Silent clubstep", "andromeda", "Avernus", "Anathema", "Acheron", "Spectre", "roses and flowers (V)", "Menace", "Abyss of Darkness", "Defeated Circles", "Tunnel of Despair (1)", "Kyouki", "Subterminal Point", "Slaughterhouse", "KOCMOC", "The Lightning Rod", "Deimos", "Eyes in the Water", "KOSETSU", "Firework", "Silentlocked", "MINUSdry", "Saul Goodman", "Apocalyptic Trilogy", "The Hallucination", "Loops of Fury", "Deadlier Clubstep", "Edge of Destiny"],
  //BUOC
  "Zoink": ["Amethyst (1)", "Thinking Space II (V)", "Flamewall (1)", "Tidal Wave (V)", "ORBIT (V)", "Nullscapes (V)", "Quanteuse processing (V)", "BOOBAWAMBA", "Every End (1)", "Penumbral", "Ashley Wave Trials (V)", "Subsuming Vortex (1)", "Silent clubstep (1)", "andromeda (1)", "Avernus (V)", "Anathema", "Acheron (V)", "Spectre", "Menace", "Abyss of Darkness", "The Bloop (V)", "Defeated Circles (V)", "Tunnel of Despair (V)", "Kyouki (1)", "Subterminal Point (1)", "Slaughterhouse (1)", "KOCMOC (1)", "The Lightning Rod (1)", "Deimos (1)", "Sakupen Circles", "Eyes in the Water", "KOSETSU", "Through The Gates (V)", "Firework", "Silentlocked (1)", "CONVULSION", "MINUSdry", "Saul Goodman (1)", "Apocalyptic Trilogy", "The Hallucination", "COMBUSTION (1)", "Deadlier Clubstep", "Edge of Destiny (1)"],
